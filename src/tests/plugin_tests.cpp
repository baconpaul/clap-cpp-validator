...
std::vector<TestCaseInfo> PluginTests::getAllTests()
{
    return {
        ...
        {"process-audio-basic",
         ...
         "whether the output does not contain any non-finite or subnormal values."},
        {"param-conversions", "Asserts that value to string and string to value conversions are "
                              "supported for either all or none of the plugin's parameters."}};
}
